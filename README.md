...
- [Wonder Mesh](https://github.com/WiresoulStudio/W_Mesh_28x): Wonder Mesh lets you create and edit parametric primitives in Blender.[![][ba-logo]](https://blenderartists.org/t/wonder-mesh/1172452). [Market](https://blendermarket.com/products/wonder-mesh)
...
- [QuickDraw](http://www.alksndr.com/quickdraw) [$]: QuickDraw is a tool that automates many of the tedious processes involved in working with Grease Pencil. It creates a very easy way to draw in Grease Pencil and have reasonably solid geometry come out of it with one click.[![][ba-logo]](https://blenderartists.org/t/quickdraw-sketch-in-grease-pencil-and-convert-to-geo/1174004). 
- [Quick Instances](https://gumroad.com/l/qinstance): Creates grouping-like workflow using regular instances.[![][ba-logo]](https://blenderartists.org/t/quick-instances-groups-addon-grouping-like-workflow/1163351). 
- [Random Object Array](https://blendermarket.com/products/random-object-array) [$]: allows you to create all kinds of object arrays that need some randomization like plants, roof tiles, cobblestone, walls, etc. using a very quick workflow without having to use a particle system. 
- [Ezlattice](https://blendermarket.com/products/ezlattice-blender-add-on-for-deformingreshaping-models-quickly) [$]: Quickly adds lattice editing to multiple objects, single objects or selected vertices in edit mode.[![][ba-logo]](https://blenderartists.org/t/ezlattice-free-plus-2-80-deform-and-reshape-models-quickly/1167836). 
- [Deform Pro](https://blendermarket.com/products/deform-pro) [$]: DeformPRO is a tool developed to make mesh deformation more dynamic and user-friendly in Blender 2.8. 
- [Bezier Mesh Shaper](https://blendermarket.com/products/bezier-mesh-shaper) [$]: This is a modeling tool that lets you use curves to deform your mesh, allowing you to make beautiful shapes. Useful for blocking and polishing forms of organic and hard surface meshes.[![][ba-logo]](https://blenderartists.org/t/bezier-mesh-shaper-v0-9-0/1138145). 
- [BezierUtils (Flexi Bezier Tools)](https://github.com/Shriinivas/blenderbezierutils): this add-on contains several tools for working with Bezier curve, similar to Illustrator's curve creation tools.[![][ba-logo]](https://blenderartists.org/t/flexi-bezier-tool/1168179).
- [Curves To Mesh](https://blendermarket.com/products/curves-to-mesh) [$]: Create and configure mesh surfaces from bezier curves. 
- [Curve Converter](https://blenderartists.org/t/curve-converter/625244/55): allows you to do is convert the curve to a mesh object and apply that data to a mesh object, without loosing the original curve. You can then update the curve and by clicking “Update Mesh” all that new data is applied to the mesh object. [![][repo]](https://github.com/BlendingJake/Curve-Converter)
...
- [Smart Fill](https://blendermarket.com/products/smart-fill-blender-add-on) [$]: This addon extends the functionally of the fill tool that by default is mapped to the F key in Blender.[![][ba-logo]](https://blenderartists.org/t/smart-fill-addon-1-3-1-blender-2-8/661598). 
- [Volume Preserving Smoothing](https://gumroad.com/l/vol_smooth): Addon for Blender for smoothing mesh surfaces without too much of volume loss.[![][ba-logo]](https://blenderartists.org/t/volume-preserving-smoothing/1115522).
- [Align Selection to Grease Pencil](https://github.com/Volantk/blender-addon-align-to-gpencil): This script will allow you to align the selection to the current grease pencil stroke. Works with vertices, objects, paths, bezier curves (except Aligned and Free type curves), edit mode bones.[![][ba-logo]](https://blenderartists.org/t/align-selection-to-grease-pencil-1-2-2-2-80/605909).
...
- Selection:
    ...
    - [Smart Select](https://gumroad.com/l/smart_select) [$]: Smart select makes selecting things in Blender much more easy. with just one click you can select things that Blender by default can't handle.[![][ba-logo]](https://blenderartists.org/t/smart-select-1-4-4-this-update-fixes-the-install-issue-and-select-mouse-problems/667800). 
    - [Context Select](https://github.com/Stromberg90/Scripts/tree/master/Blender): Emulates Maya's selections. 
    - [Ray Cast Selection](https://blenderartists.org/t/ray-cast-selection/1141012): allows you to select objects or elements of the mesh by holding the hot key and simply dragging the mouse over the desired objects. 
    - [Paint Select](https://github.com/K-410/blender-scripts/tree/master/2.8): allows you to select objects or elements of the mesh by holding the hot key and simply dragging the mouse over the desired objects.  
- Hard Surface:
    ...
    - [HardOps](https://blendermarket.com/products/hardopsofficial) [$]: Hard Ops is intended to be a (non-destructive) workflow assistant toolkit. Many tools have been added and streamlined to keep you working as fast and efficiently as possible.[![][ba-logo]](https://blenderartists.org/t/hard-ops-thread/657591). [More info](https://masterxeon1001.com/) 
    - [Boxcutter](https://blendermarket.com/products/boxcutter) [$]: Boxcutter is an on-screen 3d view drawing cutter. It allows you to Cut, Slice, Inset, Join, Knife, Extract, Make shapes.[![][ba-logo]](https://blenderartists.org/t/hard-ops-thread/657591/780). [More info](https://masterxeon1001.com/) 
    - [DECALmachine](https://blendermarket.com/products/DECALmachine) [$]: DECALmachine is a blender addon, which through mesh Decals, allows for surface detailing in a very non-committal, non-destructive, UV-less way. And as such, it represents an alternative approach to hard surface texturing.[![][ba-logo]](https://blenderartists.org/t/decalmachine/688181). [More info](https://masterxeon1001.com/) 
    - [MESHmachine](https://blendermarket.com/products/MESHmachine) [$]: MESHmachine is a blender mesh modeling addon with a focus on hard surface work without subdivision surfaces..[![][ba-logo]](https://blenderartists.org/t/meshmachine/1102529). 
    - [Fluent](https://gumroad.com/l/HtPBE) [$]: Fluent is a modeling add-on focus on non-destructive workflow and easy editing way.[![][ba-logo]](https://blenderartists.org/t/fluent-hard-surface-modeling-tools/1165523). 
    - [Fluent-PowerTrip](https://gumroad.com/l/fluent_power_trip) [$]: Fluent Power Trip contains all features from Fluent +  plate, wire, pipe and grid tools.[![][ba-logo]](https://blenderartists.org/t/fluent-hard-surface-modeling-tools/1165523). 
    - [Speedflow](https://gumroad.com/l/speedflow) [$]: addon for non-destructive workflow.[![][ba-logo]](https://blenderartists.org/t/speedflow-modeling-addon/665326).
...
- Snapping-Align:
    ...
    - [Originie](https://blendermarket.com/products/Teleport-the-pivot-with-magic-a-feature-packed-pivot-master-add-on) [$]: Originie is an add-on for manipulating the pivot's (the origin in Blender lingo) position with ease. It comes with bunch of tools that would let you move the pivot around as you "wish".[![][ba-logo]](https://blenderartists.org/t/originie-teleport-the-pivot-with-magic-a-feature-packed-pivot-master-add-on/1178430). 
    - [Toggle Orbit](https://blendermarket.com/products/toggle-orbit) [$]: Addon that adds functionality for toggling the Orbit Method in the 3D Viewport with a hotkey or with buttons added to the Header. 
    - [SnapSet](https://github.com/mkbreuer/view3d_snapset): Addon to change the pivot and snap functions at the same time, with modal and full customizable presets.[![][ba-logo]](https://blenderartists.org/t/menu-snapset-2-79-2-80-2-81a/670634).
...
- [Realistic Tree Asset Pack](https://blendermarket.com/products/realistic-tree-asset-pack) [$]: This set of assets contains 4 Tree Models, including Ash, Maple, Poplar and Spruce with 7-9 unique textures each for randomizing realism! Each tree is rigged and ready for animation.[![][ba-logo]](lien). 
...
- [Shape Generator](https://blendermarket.com/products/shape-generator) [$]: Quickly create and configure countless random shapes to find ideas and abstract concepts for inspiration, create base meshes for further editing such as spaceships, game assets. [Video](https://www.youtube.com/watch?v=GVAy4BW7-fk). 
- [Archipack](https://blender-archipack.org/) [$]: Archipack is a set of parametric architectural objects.[![][ba-logo]](https://blenderartists.org/t/archipack-1-3-8-18-04-2018/685807). [![][repo]](https://github.com/s-leger/archipack) [More info](https://blender-archipack.gitlab.io/) 
...
- [Piperator](https://yeus.gitlab.io/post/2019-10-18-piperator1/): is an addon for blender which helps generating complex pipe layouts.[![][ba-logo]](https://blenderartists.org/t/blender-addon-piperator-generation-of-pipe-networks-new-version-with-vertex-color-pipe-control/1186693).
...
- [CW Eye](https://www.blendermarket.com/products/cw-eye-a-procedural-eye-material?ref=2) [$]: CW Eye is a real procedural material shader tree for Blender. Developed for the Cycles Renderer.[![][ba-logo]](https://blenderartists.org/t/cw-eye-another-procedural-eye-material/1101434). 
...
- [Plating Generator & Greebles](https://blendermarket.com/products/plating-generator) [$]: allows you to quickly generate a plating pattern from a random seed and to select this pattern to extrude the edges accordingly.[![][ba-logo]](https://blenderartists.org/t/add-on-plating-generator-dynamic-jet/695193). 
- [Configurable Dynamic Jet](https://www.blendermarket.com/products/configurable-dynamic-jet?ref=2) [$]: allows you to dynamically configure the basic shape of the aircraft, then leaving you free to edit the base mesh by leaving the Mirror and Subdivision Surface modifiers intact.[![][ba-logo]](https://blenderartists.org/t/add-on-plating-generator-dynamic-jet/695193). 
- [Greeblefx](https://blendermarket.com/products/greeblefx-non-destructive-greeble-generator) [$]: GreebleFx simplifies the creation of panels/greebles/nurnies in Blender.[![][ba-logo]](https://blenderartists.org/t/greeblefx-non-destructive-greeble-tool/656742). 
...
- [UVPackmaster 2 PRO](https://glukoz.dev/uvp/blender/) [$]: UVPackmaster 2 is an efficient UV packing engine.[![][ba-logo]](https://blenderartists.org/t/uv-packmaster-efficient-uv-packing-solution-for-blender-c-based-multithreaded/1102737). [![][gumroad-logo]](https://gumroad.com/l/uvpackmaster2) 
...
- [Cycles Texture Paint Layers](https://github.com/David-DiGioia/blender-paint-layers): allows you to quickly create and manipulate layers in Blender’s texture paint mode. You can texture paint entirely in the 3D View with the full functionality of layers, while nodes are being generated behind the scenes, and you don’t have to go through the boilerplate of arranging and rearranging nodes to paint on different textures.[![][ba-logo]](https://blenderartists.org/t/cycles-texture-paint-layers/1126636). 
- [Bpainter](https://www.blendermarket.com/products/bpainter) [$]: BPainter offers an intuitive layersystem and brush library that you probably know from 2D painting apps. [Video](https://youtu.be/7n_bGhcLnWE). 
- [Layer Painter](https://blendermarket.com/products/layerpainter) [$]: the addon offers a powerful layer stack as well as procedural masks and painting features. [More info](https://joshuaknauber.github.io/layerpainter/getting_started/) 
- [Lily Surface Scrapper](https://github.com/eliemichel/LilySurfaceScrapper): LilySurfaceScrapper suggest a very intuitive and unified workflow: browse your favorite library in your browser. Once you have made your choice, just copy the URL of the page and paste it in Blender. The script will prompt for potential variants if some are detected, then download the maps and setup the material..[![][ba-logo]](https://blenderartists.org/t/2-80-lily-surface-scrapper-import-material-from-a-simple-url/1157897). 
- [Super Texture](https://blendermarket.com/products/super-texture?ref=2) [$]: Super Texture is a one-click addon for generating multiple PBR maps from a single image.[![][ba-logo]](https://blenderartists.org/t/super-texture-node-based-pbr-texture-generation/1143509). 
- [Pixelate Node](https://gumroad.com/l/aIehP): With this nodegroup you can pixelate any texture. Simply pass your texture coordinates through it and adjust the pixel count. 
- [Image Node Preview](https://blendermarket.com/products/image-node-preview) [$]: shows thumbnails for image texture nodes in the node editor.[![][ba-logo]](https://blenderartists.org/t/image-node-preview/1191660). 
- [Node Custom Builder](https://blendermarket.com/products/nodecustombuilder?ref=2) [$]: allows you to save your node trees and use them in your other projects.[![][ba-logo]](https://blenderartists.org/t/nodecustombuilder-2-8/1152185). 
- [Node Kit](https://blendermarket.com/products/node-kit) [$]: Node Kit is a convenient way to manage your nodes in Blender. You can easily save your nodes in a global preset, and then restore it to any object later on even in another blend file opening. You can also export all of your presets into a file and then import this file to another blender running in your other computers.[![][ba-logo]](https://blenderartists.org/t/node-kit-blender-add-on-to-manage-save-and-restore-nodes-in-node-editor/1166494). 
- [Matalogue](https://github.com/gregzaal/Matalogue): displays a list of materials and other node trees right in the toolbar of the Node Editor.[![][ba-logo]](https://blenderartists.org/t/add-on-matalogue/648455). 
- [All Material List](https://blendermarket.com/products/all-material-list) [$]: List, Rename, Select, Assign, Delete, Check for path, Broken links (...) all materials and images in your project.[![][ba-logo]](https://blenderartists.org/t/all-material-list/1162012). 
- [Color Palette Node](https://blendermarket.com/products/color-palette-node) [$]: allows you to customize the color of all the objects in the scene that are connected to the node color palette. This node allows you to create colorful, trendy color palettes for your projects.[![][ba-logo]](https://blenderartists.org/t/color-palette-node-cpn/675614). 
- [Palette Generator](https://github.com/mac7ua/Palette-Generator): a color palette generator.[![][ba-logo]](https://blenderartists.org/t/palette-generator/1180564). 
- [Extreme Pbr Combo](https://blendermarket.com/products/extreme-pbr-addon-for-blender-279-2) [$]: provides more than 1100+ pbr materials ready to use. 
- [Pbr Texture Bakery ](https://blendermarket.com/products/pbr-texture-bakery-for-cycles) [$]: The PBR Texture Bakery is an addon for Blender that allows you to bake complex Eevee/Cycles-materials to PBR-textures.[![][ba-logo]](https://blenderartists.org/t/addon-2-8-pbr-texture-bakery-materials-to-pbr-textures/1176443). 
- [Rapid Pbr Material Creator](https://blendermarket.com/products/RapidPBRMaterialCreator) [$]: Rapid PBR Material Creator is an addon that simplifies the creation of PBR materials to a SINGLE click.[![][ba-logo]](https://blenderartists.org/t/rapid-pbr-material-creator-import-pbr-materials-with-one-click/1145870). 

### 💡Lighting [^](#table)
- [LeoMoon LightStudio](https://leomoon.com/downloads/plugins/leomoon-lightstudio/): lighting system for Blender.
- [Gaffer](https://github.com/gregzaal/Gaffer): is a Blender add-on that helps you light your scenes by presenting all the right settings in convenient panels for quick access and experimentation. [[market]](https://blendermarket.com/products/gaffer-light-manager/).[![][ba-logo]](https://blenderartists.org/t/gaffer-a-lighting-hdri-manager-add-on/612871). 
...
- [Rotate an HDRI](https://gumroad.com/l/XQYEl): Addon allows you to rotate HDRI with the mouse in the style of "Marmoset toolbag" ..[![][ba-logo]](https://blenderartists.org/t/rotate-an-hdri-addon-for-blender-2-8x/1178283). 
...
- [MassFX](https://gumroad.com/l/hHuFj) [$]: Helps quickly populate your scene in a very natural way. Generates clusters of objects assigned to a collection & drops them on any surface.[![][ba-logo]](https://blenderartists.org/t/massfx-v3-dynamic-physics-painter/1114154). 
- [Object painter](https://gumroad.com/l/ObjectPainter) [$]: allows to draw by selected objects on visible scene objects.[![][ba-logo]](https://blenderartists.org/t/object-painter/1156545). 
...
- [Walker](https://www.blendermarket.com/products/walker?ref=2) [$]: Walker System is a character walk animation addon for Blender, it's primary made to work with Rigify, but can be used on other rig systems.[![][ba-logo]](https://blenderartists.org/t/walker/696838). 
- Writing/Counting: 
...
- Rigging:
    ...
    - [Auto-Rig Pro](https://blendermarket.com/products/auto-rig-pro?ref=2) [$]: Auto-Rig Pro is an advanced automatic rig addon for Blender, for bipeds, quadrupeds and similar characters.[![][ba-logo]](https://blenderartists.org/t/auto-rig-pro-3-44-released-for-blender-2-8/672834). 
    - [Bone Layer Manager](https://gumroad.com/l/STdb): Assign/Name/Edit bone layers thanks to a UI which enables the user to assign bone layers as buttons on a live Rig UI panel.[![][ba-logo]](https://blenderartists.org/t/bone-layer-manager-for-blender-2-8x/1141002).
    - [Freeik](https://www.blendermarket.com/products/freeik?ref=2) [$]: Turn basic armature into an animation ready rig in a couple of clicks, features a more intuitive way to pose and animate a model and different posing modes.[![][ba-logo]](https://blenderartists.org/t/freeik/1157419). 
    - [Rigify for MB-Lab](https://github.com/danielenger/Rigify-for-MB-Lab): This add-on adds a nearly ready-to-use Rigify Meta-Rig for Characters made with the MB-Lab add-on.[![][ba-logo]](https://blenderartists.org/t/rigify-for-mb-lab-addon-for-an-addon/1140840).
...
- Management:
    ...
    - [Asset Management](https://gumroad.com/l/asset_management): store assets (single objetcs, multiple objects, custom setup (like rendering setup with lights, floor etc.), rigged characters, Fx assets like the Grass Essential, ...).[![][ba-logo]](https://blenderartists.org/t/asset-management/660778).
...
- Display:
    ...
    - [Floating Windows](https://blendermarket.com/products/floating-windows---the-missing-feature-of-blender-2): This addon give new possibilities for its users, like for example working in full screen in the node editor while having a preview of your material floating in your workspace.[![][ba-logo]](https://blenderartists.org/t/floating-windows-the-missing-feature-of-blender-2-8-release/1163493).
- VideoEditor:
...
- [MiraTools](https://github.com/mifth/mifthtools): 3dcoat, houdini, modo mesh exchange tools and more.[![][ba-logo]](https://blenderartists.org/t/miratools/637385).
